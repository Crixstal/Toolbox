...
////////////////////////////// FUNCTIONS
    ...
    /**
     * @brief Create a quaternion from traditional radian angles.
     * @param i_eulerRadAngles Euler angles in one vector. x : yaw, y : pitch, z : roll
     */
    ...
    */
    ...
    /**
     * @return The rotation quaternion from a vector to another
     */
