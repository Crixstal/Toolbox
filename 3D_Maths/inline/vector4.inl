...
template<typename T>
inline Vector4 Vector4::operator+(const T& i_k) const
{
    return {
            i_k + x,
            i_k + y,
...
inline Vector4 Vector4::operator-(const float& i_k) const
{
    return {
            i_k - x,
            i_k - y,
...
inline Vector4 Vector4::operator+=(Vector4& i_vec)
{
    return {
            x += i_vec.x,
            y += i_vec.y,
...
template<typename T>
inline Vector4& Vector4::operator*=(const T& i_k)
{
    return this *= i_k;
}
...
inline Vector4 Vector4::Clamp(const Vector4& i_v, const float& i_min, const float& i_max)
{
