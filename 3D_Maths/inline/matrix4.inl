...
inline Vector3 Matrix4::operator*(const Vector3& i_vec) const
{
    const float w = element[3] * i_vec.x + element[7] * i_vec.y + element[11] * i_vec.z + element[15];

    return {
            (element[0] * i_vec.x + element[4] * i_vec.y + element[8] * i_vec.z + element[12]) / w,
            (element[1] * i_vec.x + element[5] * i_vec.y + element[9] * i_vec.z + element[13]) / w,
            (element[2] * i_vec.x + element[6] * i_vec.y + element[10] * i_vec.z + element[14]) / w
    };
}

inline Vector4 Matrix4::operator*(const Vector4& i_vec) const
{
...
inline Matrix4 Matrix4::operator*(const Matrix4& i_mat) const
{
    Matrix4 result = {};
...
inline bool Matrix4::operator==(const Matrix4& i_mat) const
{
    bool result = true;
    for(int i = 0; i < 16 && result; i++)
        result = Maths::Abs(element[i] - i_mat.element[i]) <= Maths::Constants::weakEpsilon;
...
{
    return o_o << i_mat.element[0] << ", " << i_mat.element[1] << ", " << i_mat.element[2] << ", " << i_mat.element[3] << ",\n"
             << i_mat.element[4] << ", " << i_mat.element[5] << ", " << i_mat.element[6] << ", " << i_mat.element[7] << ",\n"
             << i_mat.element[8] << ", " << i_mat.element[9] << ", " << i_mat.element[10] << ", " << i_mat.element[11] << ",\n"
             << i_mat.element[12] << ", " << i_mat.element[13] << ", " << i_mat.element[14] << ", " << i_mat.element[15] << "\n";
}
